  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="index.html">
          <img src="assets/backend/images/logo/logo.svg" alt="logo" />
        </a>
      </div>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse show dropdown-nav">
              <li>
                <a href="{{ route('banner.index') }}" class="{{ request()->routeIs('banner.*') ? 'active' : '' }}"> Banner </a>
              </li>
              <li>
                <a href="{{ route('project.index') }}" class="{{ request()->routeIs('project.*') ? 'active' : '' }}"> Project </a>
              </li>
              <li>
                ...
                {{-- <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  >
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="assets/backend/images/lead/lead-6.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            John Doe
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="assets/backend/images/lead/lead-1.png" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            Jonathon
                ...
                <div class="profile-box ml-15">
                  ...
                  >
                    <div class="profile-info">
                      <div class="info">
                        <h6>Manish Adhikari</h6>
                        <div class="image">
                            <img src="{{ asset('uploads/about/'.@$about->image) }}" alt="" height="50px" width="200">
                  ...
                  >
                    ...
                    <li>
                      <a href="{{ route('updateform') }}"> <i class="lni lni-lock-alt"></i> password Change </a>
                    </li>
                    <li>
                        <a  href="{{ route('logout') }}"
